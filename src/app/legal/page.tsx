...
const sections = [
  {
    ...
    body: [
      "Data yang Kami Kumpulkan: PriceHunt mengumpulkan data akun (email, nama tampilan), wishlist produk, price alert, review, preferensi notifikasi, dan riwayat pencarian untuk menjalankan fitur yang Anda pilih. Kami juga mengumpulkan data teknis seperti IP address, user agent, dan log error untuk keamanan dan stabilitas layanan.",
  ...
  },
  {
    ...
    body: [
      "Penggunaan Layanan: PriceHunt membantu membandingkan dan menganalisis harga dari data yang tersedia. Kami menyediakan informasi, rekomendasi, dan tools untuk membantu keputusan belanja. Keputusan pembelian akhir tetap menjadi tanggung jawab Anda.",
      ...
      "Penggunaan yang Dilarang: Jangan menggunakan PriceHunt untuk scraping agresif, penyalahgunaan API, spam review palsu, manipulasi rating, distributed attacks, atau aktivitas yang melanggar hukum dan ketentuan marketplace. Jangan mengirim malware, virus, atau kode berbahaya.",
      ...
      "Hak Kekayaan Intelektual: Konten PriceHunt (desain, code, branding, copy) dilindungi hak cipta. Data harga marketplace adalah milik marketplace terkait. Anda boleh menggunakan PriceHunt untuk keperluan pribadi, tidak untuk redistribusi komersial tanpa izin.",
      "Batasan Tanggung Jawab: PriceHunt disediakan 'as is' tanpa garansi ketersediaan 100%. Kami tidak bertanggung jawab atas kerugian finansial akibat keputusan pembelian, downtime layanan, kesalahan data harga, atau kehilangan data akibat force majeure. Tanggung jawab kami terbatas pada biaya langganan yang Anda bayarkan (jika ada).",
